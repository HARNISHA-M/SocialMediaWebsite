...
export const Myprofile = () => {
    ...
    const getPostCount =async () => {
        {profilePost && setPostCount(profilePost?.length) }
    }
        ...
        <div className="myProfile">
            <div className="topBar">
                  <div className="profilePic">
                    {urldata && urldata.url.length>5 && <img src={urldata && urldata.url}  width="100" height="1000" className="profilePicture"></img>}
                    {urldata && urldata.url.length<5 && <img src={require('../components/profileDummy.png')} width="100" height="100" className="profilePicture"></img>}
